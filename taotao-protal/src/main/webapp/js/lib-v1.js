...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://127.0.0.1:8081/rest/itemcat/all?callback=category.getDataService",//跨域访问 taotao-rest
		//URL_Serv: "http://localhost:8082/category.json",
		//URL_Serv: "http://localhost:8081/category.json",//跨域访问 taotao-rest
